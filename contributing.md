...
- El proyecto debe **dar soporte específico a las Islas Canarias** o incluir funcionalidades relevantes para usuarios en esta comunidad autónoma.
...
5. **Incluye en la descripción de la PR la URL del servicio, API o institución canaria** a la que el software da soporte (p.ej. gobiernodecanarias.org, istac.es, ull.es). Esto ayuda a verificar que el proyecto es relevante para las Islas Canarias.
