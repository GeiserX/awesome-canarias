...
- URL del repositorio
- URL del servicio/API/institución canaria a la que da soporte (p.ej. gobiernodecanarias.org, istac.es, ull.es)
Elimina esta sección si no aplica.
-->

| Proyecto | Servicio/Institución canaria |
|----------|------------------------------|
...
- URL del repositorio
- Motivo (archivado, no funcional, reemplazado, no específico de Canarias, etc.)
Elimina esta sección si no aplica.
-->
