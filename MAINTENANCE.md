...
Un repositorio se incluye porque interactúa con instituciones, servicios, infraestructura, normativas o datos propios de Canarias. No basta con que el autor sea de Canarias o resida aquí. Un framework genérico creado por un developer de Canarias no pertenece a esta lista. Un cliente para una API de servicios de Canarias sí.
